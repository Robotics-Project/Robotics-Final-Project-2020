...
critic = rlQValueRepresentation(criticNetwork, ...
                          ...
                          env.getActionInfo,'Observation',{'observation'},'Action',{'action'},criticOptions);
...
actor = rlDeterministicActorRepresentation(actorNetwork, ...
                          env.getObservationInfo, ...
                          env.getActionInfo,'Observation',{'observation'},'Action',{'ActorTanh1'},actorOptions);
%{
actorNetwork,actorOptions, ... 
