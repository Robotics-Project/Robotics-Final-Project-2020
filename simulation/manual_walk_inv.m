...
y0 = L*0.85;  % Height of mass in middle of stance phase
...
th1 = 0.6914; %initial angle of upper-leg to vertical, multiple options (chosen due to ease)
th1_0 = 25*pi/180; %angle of th1 at midstance
...
th2 = 1.7588; %initial knee angle
th2_0 = 2*asin((L/2)/l1); %knee angle at rest
m1 = 2/(l1+l2); 
...
k2 = k*dif_Ls*l1*sin(th1_mid)/(th2-th2_mid); %knee siting at mid stance based on stiffness values asssumed earlier
...
T_wait_step = 3*T_gait/4; %wait between first step and movement for second set of legs
